...
(use-package multi-term
  :ensure t
  :commands (multi-term)
  :bind (("C-c C-t v" . cube/multi-term-vertical)
         ("C-c C-t h" . cube/multi-term-horizontal)
         ("C-c C-t t" . cube/multi-term))
  :config
