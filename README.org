...
(use-package org
  ...
  (progn
    ...
    (setq org-refile-targets '(("~/Dropbox/Org/Todo/projects.org" :maxlevel . 3)
                               ("~/Dropbox/Org/Todo/someday.org" :level . 1)
                               ("~/Dropbox/Org/Todo/tickler.org" :maxlevel . 2)))

    ;; Set org-capture templates
    (setq org-capture-templates '(("t" "Todo [inbox]" entry (file+headline "~/Dropbox/Org/Todo/inbox.org" "Tasks") "** TODO %i%?")
                                  ("T" "Tickler" entry (file+headline "~/Dropbox/Org/Todo/tickler.org" "Tickler") "* %i%? \n %U")
                                  ("n" "Note" entry (file+headline "~/Dropbox/Org/Notes/inbox.org" "Notes") "* NOTE %?\n%U" :empty-lines 1)))))
